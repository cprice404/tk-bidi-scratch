(ns tk-bidi-scratch.tk-bidi-scratch-web-core-test
  (:require [clojure.test :refer :all]
            [tk-bidi-scratch.tk-bidi-scratch-service :as hello-svc]
            [tk-bidi-scratch.tk-bidi-scratch-web-core :refer :all]
